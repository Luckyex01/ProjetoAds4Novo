...
const TestimonialScreen: React.FC = () => {
  ...
  const imgSize = screenWidth * 0.25;

  // Cria um array de animações para cada item
  ...
  // Referência para o primeiro TextInput (nome) para forçar o foco
  const nameInputRef = useRef<TextInput>(null);

  // Quando o modal abrir, forçamos o foco no primeiro campo
  useEffect(() => {
    if (modalVisible && nameInputRef.current) {
      setTimeout(() => {
